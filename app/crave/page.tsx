      ...
      <div>
        ...
        >
          <h1 className="md:text-3xl text-xl font-bold">
            🐱 Purrfect progress! We&apos;re 25% there and feline good about it!
            🚀
          </h1>
          <button
            className="font-bold md:text-3xl text-xl border
                    w-auto h-20 cursor-pointer bg-[#ffffff] border-[#c9c9c9] px-10 py-1 rounded-2xl"
          >
            Go to Surfe home
          </button>
        </Link>
