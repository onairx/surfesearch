...
export default function Main() {
    ...
    return (
        ...
        >
            <div style={backgroundNoice} className="w-full h-full flex flex-col justify-between items-center">
                <div className="flex flex-col justify-center items-center w-full h-full gap-5 md:p-5 p-2 mb-20">
                    <div className="w-auto h-auto flex flex-col md:gap-10 gap-5 justify-center items-center">
                        <div className="flex flex-col justify-center items-center w-full h-auto text-center pointer-events-none">
                            ...
                            <p className={showImage ? 'text-[#ffffff] mix-blend-difference' : 'text-[#0a0a0a]'}>Search the web for you</p>
                        </div>
                        <div className="flex justify-center items-center w-full h-auto gap-5">
                            <Link href="https://crumbs-seven.vercel.app" target="_blank">
                                <div className={`${showImage ? 'bg-[#0a0a0a99] border-[#696969] hover:bg-[#0a0a0a55] thetransition' :
                                    'bg-[#0d0d0d2a] border-[#C8C8C8] hover:bg-[#5757572a] thetransition'} crumbandcave`}>
                                    <button className={`${showImage ? 'text-white' : 'text-white'} flex gap-1 cursor-pointer`}>
