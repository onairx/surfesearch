    ...
    return (
        <footer className="text-start w-full h-auto text-sm flex justify-between items-center gap-2 select-none md:p-5 p-2">
            <div className="w-[90%] h-auto">
                ...
                <p className="text-[#696969] md:text-[1em] text-[0.9em]">
                    <a href="https://vishalonairx.vercel.app">Designed and developed by onairx</a>
                </p>
            </div>
            <div className={`${showIcon ? 'bg-[#0a0a0a36] border-[#c9c9c96d]' : 'bg-[#fffffff0] border-[#C9C9C9] mix-blend-difference'} border 
                ...
                <button className={`${showIcon ? 'text-white' : 'text-black'} 
